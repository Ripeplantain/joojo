...
// Query: *[_type == "lesson" && slug.current == $slug][0]{    _id,    title,    slug,    videoUrl,    thumbnail,    duration,    freePreview,    studentCount,    notes,    keyPoints,    proTip,    resources  }
